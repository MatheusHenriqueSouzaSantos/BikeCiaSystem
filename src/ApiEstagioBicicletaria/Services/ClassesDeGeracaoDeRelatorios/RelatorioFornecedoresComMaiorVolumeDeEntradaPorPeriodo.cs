        ...
        public void Compose(IDocumentContainer container)
        {
            ...
            container.Page(page =>
            {
                ...
                page.Content().Column(col =>
                {
                    ...
                    col.Item().Text($"Relatório de Fornecedores Com Maior Volume de Entrada Por Período: {_dataInicialDoPeriodo:dd/MM/yyyy} à " +
                        $"{_dataFinalDoPeriodo:dd/MM/yyyy}").FontSize(20).Bold();
                    ...
                    col.Item().Table(table =>
                    {
                        ...
                        else
                        {
                            foreach (FornecedorComMaisEntradasDto fornecedorComDadosEntrada in _fornecedoresComDadosEntrada)
                            {
                                ...
                                .Text($"{fornecedorComDadosEntrada.Cnpj[..2]}.{fornecedorComDadosEntrada.Cnpj[2..5]}" +
                                $".{fornecedorComDadosEntrada.Cnpj[5..8]}/{fornecedorComDadosEntrada.Cnpj[8..12]}-{fornecedorComDadosEntrada.Cnpj[12..]}")
                                .FontSize(10);
