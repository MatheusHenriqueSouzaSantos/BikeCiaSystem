    ...
    public class VendaService : IVendaService
    {
        ...
        public byte[] GerarRelatorioDeVendasPorPeriodo(DatasParaGeracaoDeRelatorioDto dto)
        {
            ...
            foreach(Venda vendaIterada in vendasNoPeriodo)
            {
                ...
                Transacao? transacaoDaVenda = _contexto.Transacoes.Where(t => t.IdVenda == vendaIterada.Id).FirstOrDefault();
                ...
                string dataDaVenda = DateOnly.FromDateTime(vendaIterada.DataCriacao).ToString("dd/MM/yyyy");
